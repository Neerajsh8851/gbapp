...
public class DecorationAdapterasd extends RecyclerView.Adapter<DecorationAdapterasd.MyViewHolder> {

    //Prefrance
    public static PrefManagersd prf;

    private ArrayList<Fontsadsd> decorationFontsadsds;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(activity).inflate(R.layout.adapter_decorationt, parent, false);
        return new MyViewHolder(row);
    }

    public DecorationAdapterasd(ArrayList<Fontsadsd> fontsadsdItems, Context activity) {
        this.decorationFontsadsds = fontsadsdItems;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        final Fontsadsd f = decorationFontsadsds.get(position);
    ...
    public int getItemCount() {
        return decorationFontsadsds.size();
    }
